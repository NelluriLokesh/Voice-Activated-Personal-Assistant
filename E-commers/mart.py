...
def login():
    ...
    if username in users and users[username] == hashed_password:
        ...
        print("You have Logined successful!")
        engine.say(" You have Logined successful!")
        engine.runAndWait()
        users[username[1]] += 1
        return True
    else:
...
def display_bill():
    ...
    com = int(input('Do you an gift card '))
    engine.say("Do you an gift card")
    engine.say("type yes to add")
    engine.say("or no")
    engine.runAndWait()
